    ...
    <React.Fragment>
      ...
      <div className="home__page__course__container ">
        <div className="container">
          <div className="pt-5 flex-between">
            ...
            <div className="flex">
              <div
                className="homepage__prev__course__icon pointer flex-center me-5"
                onClick={() => controlRef.current.slickPrev()}
              >
                <Icon name="arrow-left" fill="#111" />
              </div>
              <div
                className="homepage__next__course__icon pointer flex-center"
      ...
      <div className="home__page__details container">
        ...
        <div className="row">
          ...
          <div className="col-lg-6  position-relative flex-center">
            <div className=" mt-5">
